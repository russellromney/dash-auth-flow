...
@app.callback(
    [
        Output("register-" + x, "valid")
        for x in ["first", "last", "email", "password", "confirm"]
    ]
    + [
        Output("register-" + x, "invalid")
        for x in ["first", "last", "email", "password", "confirm"]
    ]
    + [
...
@app.callback(
    [Output("register-url", "pathname"), Output("register-alert", "children")],
    [Input("register-button", "n_clicks")],
    [
        State("register-" + x, "value")
        for x in ["first", "last", "email", "password", "confirm"]
    ],
)
