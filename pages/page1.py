...
login_alert = dbc.Alert("User not logged in. Taking you to login.", color="danger")
    ...
    return dbc.Row(
        dbc.Col(
            [
                ...
                dcc.Loading(
                    html.Iframe(
                        id="page1-test", style=dict(height="500px", width="100%")
                    ),
                    id="page1-loading",
                ),
            ],
...
@app.callback(Output("page1-test", "src"), [Input("page1-test-trigger", "children")])
